...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            ExpectedCondition cond1 = ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(String
                    .format("//div[@class='MuiCardContent-root css-1qw96cp'][1]/p[contains(text(),'%s')]", product)));
            ExpectedCondition cond2 = ExpectedConditions.visibilityOfElementLocated(By.xpath("//h4[text()=' No products found ']"));
            wait.until(ExpectedConditions.or(cond1,cond2));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
